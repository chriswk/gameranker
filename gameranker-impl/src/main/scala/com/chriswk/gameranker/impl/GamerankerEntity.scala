...
/**
  * This is an event sourced entity. It has a state, [[GamerankerState]], which
  ...
  */
class GamerankerEntity extends PersistentEntity {

  override type Command = GamerankerCommand[_]
  override type Event = GamerankerEvent
  override type State = GamerankerState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: GamerankerState = GamerankerState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case GamerankerState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        GamerankerState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class GamerankerState(message: String, timestamp: String) extends Jsonable

object GamerankerState {
  /**
    ...
    */
  implicit val format: Format[GamerankerState] = Json.format
}

/**
  * This interface defines all the events that the GamerankerEntity supports.
  */
sealed trait GamerankerEvent extends Jsonable

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends GamerankerEvent
...
/**
  ...
  */
sealed trait GamerankerCommand[R] extends Jsonable with ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends GamerankerCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String, organization: Option[String]) extends GamerankerCommand[String]
